<h1 align="center">
  <img src="https://github.com/splrad.png?size=200" alt="SPLRAD 标志" width="112" /><br>
  SPLRAD
</h1>

<p align="center"><strong>把想法做成软件，也把软件认真维护下去。</strong></p>

<p align="center">
  <a href="https://github.com/splrad?tab=repositories">浏览项目</a> ·
  <a href="#正在构建">正在构建</a> ·
  <a href="mailto:alearner@splrad.com">联系 SPLRAD</a>
</p>

SPLRAD 是一个由个人独立维护的开发组织。这里收纳正在使用、持续改进，也愿意拿出来公开分享的软件项目。关注的领域会变化，项目也会慢慢增加。比起先限定自己做什么，我们更在意它是否真正有用，能否长期维护。
